...
export const linearLuminanceColorSpace: LuminanceColorSpace =
  Object.freeze<LuminanceColorSpace>({
    toLuma: v => v,
    fromLuma: v => v,
  });

export const srgbLuminanceColorSpace: LuminanceColorSpace =
  Object.freeze<LuminanceColorSpace>({
    toLuma: luminance => {
...
export const createLuminanceColorSpace = (
  ...
  if (gamma === 1) {
    return linearLuminanceColorSpace;
  }

  // sRGB space.
  if (gamma === 0) {
    return srgbLuminanceColorSpace;
  }
